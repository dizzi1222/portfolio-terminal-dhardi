...
export const i18n = {
  es: {
    ...
    tech: {
      ...
      'Canvas': 'Diseño y prototipado visual. Mockups y wireframes interactivos.',
  ...
  en: {
    ...
    tech: {
      ...
      'Canvas': 'Visual design and prototyping. Interactive mockups and wireframes.',
  ...
  de: {
    ...
    tech: {
      ...
      'Canvas': 'Visuelles Design und Prototyping. Interaktive Mockups und Wireframes.',
